...
<html lang="en">
  ...
  <meta name="request-id" content="F897:41EE:12866AA:216BF93:5B8AFCA7" data-pjax-transient>
...
<meta class="js-ga-set" name="dimension1" content="Logged Out">
    ...
    <meta name="js-proxy-site-detection-payload" content="ZWNjM2I2YjI3NDlhZTdhMmFhZGFiY2YxNGJkNjUyMWM3MWRiM2YzOTJiYTMwNGFhZDI5ZGVjNTVkYjgwNzI2MXx7InJlbW90ZV9hZGRyZXNzIjoiMjQuMy4xOS4yNDIiLCJyZXF1ZXN0X2lkIjoiRjg5Nzo0MUVFOjEyODY2QUE6MjE2QkY5Mzo1QjhBRkNBNyIsInRpbWVzdGFtcCI6MTUzNTgzNTMzMywiaG9zdCI6ImdpdGh1Yi5jb20ifQ==">
  ...
  <meta name="html-safe-nonce" content="f95301332b6719ea1450b366d21fdaaa96cab3fc">
...
>
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" data-scope-type="Repository" data-scope-id="50450433" data-scoped-search-url="/udacity/machine-learning/search" data-unscoped-search-url="/search" action="/udacity/machine-learning/search" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />
      <label class="form-control header-search-wrapper header-search-wrapper-jump-to position-relative d-flex flex-justify-between flex-items-center js-chromeless-input-container">
        <input type="text"
          ...
          data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations#csrf-token=AfRCS9RXkA0mI20G3mQDvbstrk0k3gDSfnYfotSLcuQ7xpSrhpKvxbYGopfmURI0JXTmbvOBwkvyfDrr69KcqQ=="
          spellcheck="false"
          autocomplete="off"
          >
          ...
          <span class="d-inline-block">
              <div class="HeaderNavlink px-0 py-2 m-0">
                <a class="text-bold text-white no-underline" href="/login?return_to=%2Fudacity%2Fmachine-learning%2Fblob%2Fmaster%2Fprojects%2Ffinding_donors%2FREADME.md" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in; experiment:site_header_dropdowns; group:control">Sign in</a>
  ...
  <li>
    ...
    <a class="social-count js-social-count" href="/udacity/machine-learning/stargazers"
      aria-label="2273 users starred this repository">
      2,273
    </a>
...
<div class="container new-discussion-timeline experiment-repo-nav  ">
  ...
  <!-- blob contrib key: blob_contributors:v21:dac2cd6aabd61be7a7794d71b689e388 -->
      ...
      <div class="signup-prompt p-4 text-center mb-4 rounded-1">
        <div class="position-relative">
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form action="/site/dismiss_signup_prompt" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="tTabv7F74SIGOhmM7Wd05NgQ+HKemOxLCfmdh1U5doZs2l1hZZidSijwjGHNffAO5mVSdxMW1/V5jIfAByGzyw==" />
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between pt-6 pb-2 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2018 <span title="0.15906s from unicorn-75bc777dc4-v4n7x">GitHub</span>, Inc.</li>
